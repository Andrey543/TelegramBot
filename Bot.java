...
public class Bot extends TelegramLongPollingBot {
    ...
    public String getBotUsername() {
        return "we54trgdbf_bot";
    }

    @Override
    public String getBotToken() {
        return "6660334624:AAGDwOsnGhHVGTKYT9BTAlE4MYPGjdSgDlo";
    }
    ...
    private ReplyKeyboardMarkup getKeyboard(Class someClass) {
        ...
        for (int rowIndex = 0; rowIndex < rowsCount; rowIndex++) {  KeyboardRow row = new KeyboardRow();
